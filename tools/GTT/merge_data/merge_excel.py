...
if __name__ == "__main__":
	file1="Expenses-Payroll.xlsx"
	file2="HOP 2 & TVL March 2020  Reconciliation Final.xlsx"
	merged_file="Merge-Payroll-Vacation-Expenses.xlsx"

	data_matrix1 = xlsread(file1, 'Salary')

	data_matrix2 = xlsread(file2, 'March Compensation Hop 2 & TVL')
